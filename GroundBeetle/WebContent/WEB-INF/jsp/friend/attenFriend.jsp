	...
	<table border="0" align="center" cellpadding="0" cellspacing="0"
		...
		<tr>
			<td width="670" height="600" valign="top">
				...
				</table> <!-- weibo 开始--> <c:forEach items="${attUsers}" var="attUser">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<td><a
											...
											style="text-decoration: none">已关注</a></td>
									</tr>
									<tr>
									...
									<tr>
										<td>${attUser.sign}</td>
										<td><a
											href="toBlackOrQXGZ?operation=LH&bId=${attUser.id}"
				...
				<table align="center" id="page">
					<tr>
						<td align="right"><c:if test="${pageBean.page!=1}">
								<a href="AF_pageUpAndDown?operation=Up&pageId=${pageBean.page}"
									style="text-decoration: none">上一页</a>&nbsp; &nbsp;     
        	</c:if> 第&nbsp; ${pageBean.page} &nbsp;页 &nbsp;&nbsp; <c:if
								test="${pageBean.page != pageBean.totalPage}">
								<a
									href="AF_pageUpAndDown?operation=Down&pageId=${pageBean.page}"
