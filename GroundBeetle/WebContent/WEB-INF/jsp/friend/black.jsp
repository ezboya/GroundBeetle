	...
	<table border="0" align="center" cellpadding="0" cellspacing="0"
		...
		<tr>
			<td width="670" height="600" valign="top">
				...
				</table> <!-- weibo 开始--> <c:forEach items="${black}" var="attUser">
							...
							<td width="76%" valign="top">
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<td><a
											href="friendOperation?operation=QXLH&nPage=black&uId=${attUser.id}"
											style="text-decoration: none">取消拉黑</a></td>
									</tr>
									<tr>
				...
				<table align="center" id="page">
					<tr>
						<td align="right"><c:if test="${pageBean.page!=1}">
								<a href="blank_index?p=${pageBean.page-1}"
