...
<body>
	...
	<table border="0" align="center" cellpadding="0" cellspacing="0"
		style="width: 950px; background-color: #EBEEF3">
		<tr>
			<td>
				<!--效果html开始-->
				<div class="content">
						...
						<div class="chatLeft">
							<div class="chat01">
								<div class="chat01_title">
									<ul class="talkTo">
										<li><a href="javascript:;">${bUser.nickName}</a></li>
									</ul>
								</div>
									...
									<div class="message_box mes3" style="display: block;">
										...
										<c:forEach items="${messageList}" var="message">
											<div class="message clearfix">
												<div class="user-logo">
													<img src="${message.userA.images}" width="50px"
														height="50px">
												</div>
												<div class="wrap-text">
							...
							<div class="chat02">
								<div class="chat02_title">
									<a class="chat02_title_btn ctb01" href="javascript:;"
										onclick="Ashow()"></a>
									<div id="faces"></div>
								</div>
								<form action="sendMessage?userBId=${bUser.id}" method="post">
									...
									<div class="chat02_bar">
										<ul>
											...
											<li style="right: 5px; top: 5px;"><input type="image"
												src="img/send_btn.jpg" onclick="subMessage()"> <script
						...
						<div class="chatRight">
							<div class="chat03">
								<div class="chat03_title">
									<label class="chat03_title_t"> 联系好友</label>
								</div>
								<div class="chat03_content">
									<ul>
										<c:forEach items="${attUsers}" var="attUser">
											<li><a href="message?userBId=${attUser.id}"> <img
													src="${attUser.images}"></a><a
												href="message?userBId=${attUser.id}" class="chat03_name">&nbsp;&nbsp;&nbsp;${attUser.nickName}
