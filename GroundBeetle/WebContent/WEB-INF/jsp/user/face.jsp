...
<body>
	...
	<table border="0" align="center" cellpadding="0" cellspacing="0"
		id="container">
		<tr>
			<td width="670" valign="top"><form action="updateFace"
					method="post" enctype="multipart/form-data"
					onsubmit="return chechMyFace()">
					<table border="0" align="center" cellpadding="0" cellspacing="0"
						id="userinfo">
						<tr>
						...
						<tr>
							<td class="menu"><a href="userinfo_index">基本资料</a> | <a
								href="pwd_index">修改密码</a> | 修改头像 | <a href="question_index">修改密保</a></td>
						</tr>
						<tr>
							<td align="center"><table width="90%" border="0"
									...
									<tr>
										<td width="20%" align="center"><span id="showIcon"><img
												src="${loginUser.images}" width="120" height="120" id="pic" /></span>
										</td>
										<td width="53%"><p>
												<input type="file" name="icon" id="icon"
													onmouseout="checkIcon()" /> <input type="submit"
													style="CURSOR: hand" name="Submit" id="Submit" value=" 上传 " />
											</p>
