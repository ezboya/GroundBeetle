					...
					<tr>
						...
						<td width="49%" align="center">
							<form id="form1" name="form1" method="post"
								action="seach?ac=user&pag=1">
								<input name="key" type="text" class="input" id="textfield"
									placeholder="输入昵称。。。" /> <input name="button" type="submit"
									class="btnsearch" id="button" value="搜索" />
							</form>
						</td>
					</tr>
				</table> <!-- weibo 开始--> <c:forEach items="${map.user}" var="attUser">
							...
							<td width="76%" valign="top">
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<td><a
											href="toBlackOrQXGZ?operation=QXGZ&bId=${attUser.id}"
											style="text-decoration: none">关注</a></td>
									</tr>
									<tr>
										...
										<td>
											<%-- <a href="message?userBId=${attUser.id}" style="text-decoration:none">私信</a> --%>
										</td>
									</tr>
									<tr>
										<td>${attUser.sign}</td>
										<td>
											<%-- <a href="toBlackOrQXGZ?operation=LH&bId=${attUser.id}" style="text-decoration:none">拉黑</a> --%>
										</td>
									</tr>
								</table>
							</td>
				...
				<table align="center" id="page">
					<tr>
						<td align="right"><c:if test="${map.pageBean.page!=1}">
								<a href="seach?ac=user&pag=${map.pageBean.page-1}"
