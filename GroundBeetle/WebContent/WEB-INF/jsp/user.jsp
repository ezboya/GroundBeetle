		...
		<tr>
			<td width="670" height="600" valign="top">
				<table width="90%" border="0" align="center" cellpadding="0"
					cellspacing="0" id="curruser" background="${user.images}">
					<tr>
						<td width="24%"><img src="${user.images}" width="120"
						...
						<td width="76%" valign="top"><table width="100%" border="0"
								...
								<tr>
									<td><p>
											<a href="#">${user.email}<br />
											</a>积分：${user.integral}<br /> 签名：${user.sign}<br /> <a href="#">+添加关注</a>
										</p></td>
								</tr>
							</table></td>
					</tr>
				</table> <!-- weibo 开始--> <c:forEach items="${list}" var="weibo">
				...
				<table align="center" id="page">
					<tr>
						<td align="right"><c:if test="${pageBean.page!=1}">
								<a href="user_index?p=${pageBean.page-1}&userId=${user.id}"
