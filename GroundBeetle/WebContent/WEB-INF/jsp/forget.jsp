...
<body>
	...
	<table border="0" align="center" cellpadding="0" cellspacing="0"
		id="container">
		<tr>
			<td width="670" valign="top"><form
					action="up_forget?email=${fUser.email}" id="forgetForm"
					method="post">
					<table border="0" align="center" cellpadding="0" cellspacing="0"
						id="register">
						<tr>
						...
						<tr>
							<td><table width="90%" border="0" cellpadding="5"
									...
									<tr>
										<td align="center">&nbsp;</td>
										<td align="left"><input type="submit" value="修改"></input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
