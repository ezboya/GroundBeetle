			...
			<td width="280" align="center" valign="top">
				...
				<form id="form1" name="form1" method="post" action="adminlogin">
					<table id="login" width="220" border="0" cellspacing="0"
						...
						<tr>
							<td colspan="2">用户名 <input name="name" type="text" />
							</td>
						</tr>
						<tr>
							<td colspan="2">密&nbsp;&nbsp;&nbsp;&nbsp;码 <input
								name="password" type="password" />
							</td>
						</tr>
						<tr>
							<td><input name="Submit" type="submit" class="loginbtn"
								id="Submit" value="登录 " /></td>
							<td><input name="reset" type="reset" class="loginbtn"
