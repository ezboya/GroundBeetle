...
import recordLife.service.IAdminService;
...
public class IAdminServiceImpl implements IAdminService{
	...
	public List<User> userManage(PageBean page) throws UserServiceException {
		List<User> list = null;
		try {
			list = adminDao.findAllUser(page.getPage(),page.getMaxPage());
		} catch (DataAccessException e) {
			e.printStackTrace();
		}
		return list;
	...
	public List<User> userManageByKey(PageBean page, String key) throws UserServiceException {
		List<User> list = null;
		try {
			//System.out.println("page======="+page+"======"+page.getPage());
 			list = adminDao.findAllUserByKey(key,page.getPage(),page.getMaxPage());
	...
	public List<Weibo> findWeibo(PageBean pageBean, String key) throws UserServiceException {
		...
		try {
			...
			list = adminDao.findWeiboByKey(nkey, pageBean.getPage(), pageBean.getMaxPage());
	...
	public List<Conch> findConch(PageBean pageBean, String key) throws UserServiceException {
		...
		try {
			...
			list = adminDao.findConchByKey(nkey, pageBean.getPage(), pageBean.getMaxPage());
